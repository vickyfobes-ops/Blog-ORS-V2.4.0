...
2. Opening answer in the first paragraph, ideally a self-contained 40–70 words and always within the first 80 words: state the governing decision and the main tradeoff.
...
- Make the public title (`meta.json.title`, intended as the template's sole H1), opening answer, one H2, meta description, and image alt text mutually consistent without repeating the same sentence. Never repeat the title as an H1 in the Shopify body; confirm the selected template's rendered H1 before live publication.
