...
- Origin-owned real images are preferred when relevant; generated scenarios are disclosed in `image-plan.md` and never represented as completed Origin projects.
