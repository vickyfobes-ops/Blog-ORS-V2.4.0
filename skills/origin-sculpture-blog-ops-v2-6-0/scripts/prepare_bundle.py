...
USER_AGENT = "OriginSculptureBlogSkill/2.6.0 (+https://originsculpture.com)"
...
def main() -> int:
    ...
    if any(tag == "h1" for tag, _ in parsed.headings):
        blockers.append("article.html must not contain H1; Shopify renders meta.title as H1")
